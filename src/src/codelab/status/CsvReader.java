...
public class CsvReader {
    ...
    public static void main(String[] args) {
        ...
        List<codelab.status.Trainee> roster = new ArrayList<codelab.status.Trainee>();
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                roster.add(new codelab.status.Trainee(name[5].replace("\"", ""), name[4].replace("\"",
