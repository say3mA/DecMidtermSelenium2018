...
public class ConnectToMongoDB {
    ...
    public static List<databases.User> readUserProfileFromMongoDB(){
        List<databases.User> list = new ArrayList<databases.User>();
        ...
        for(Document doc:iterable){
            ...
            user.setStID(stDOB);
            user = new databases.User(stName,stID,stDOB);
            list.add(user);
        }
        return list;
    }
    ...
    public static void main(String[] args){
        insertIntoToMongoDB(new databases.User("Naomi Chan", "4493","07-1996"));
        List<databases.User> user = readUserProfileFromMongoDB();
